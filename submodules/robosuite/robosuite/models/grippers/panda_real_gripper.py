...
class PandaRealGripperBase(GripperModel):
    """
    Gripper for Franka's Panda (has two fingers).
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/panda_gripper_real.xml"), idn=idn)
...
class PandaRealGripper(PandaRealGripperBase):
    """
