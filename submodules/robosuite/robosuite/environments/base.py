...
class MujocoEnv(metaclass=EnvMeta):
    ...
    def __init__(
        ...
        self.joint_torque_rate_limits = np.ones(7)*1000
    ...
    def reset(self):
        ...
        return self._get_observation(force_update=True)
    ...
    def _update_observables(self, force=False):
        ...
        for observable in self._observables.values():
            observable.update(timestep=self.model_timestep,
                              obs_cache=self._obs_cache, force=force)
    ...
    def step(self, action):
        ...
        for i in range(substeps):
            # self.sim.forward()  # No need to do this here
