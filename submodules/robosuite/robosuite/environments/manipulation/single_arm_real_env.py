...
from robosuite.robots import SingleArmReal
from robosuite.utils.transform_utils import mat2quat


class SingleArmRealEnv(ManipulationEnv):
    """
    ...
    def _load_model(self):
        ...
        assert isinstance(self.robots[0], SingleArmReal), \
    ...
    def _check_robot_configuration(self, robots):
        ...
        if type(robots) is list:
            assert len(
                robots) == 1, "Error: Only one robot should be inputted for this task!"
